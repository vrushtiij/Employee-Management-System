...
const ViewEmployee = () => {
  ...
  const fetchEmployee = async () => {
    try {
      const res = await axios.get(`http://localhost:5000/view/${employee_id}`,{ withCredentials: true });
  ...
  const fetchWork = async () => {
    try{
      const res = await axios.get(`http://localhost:5000/viewWork/${employee_id}`,{ withCredentials: true });
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(`http://localhost:5000/delete/${employee_id}`, {withCredentials: true});
